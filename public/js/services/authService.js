    ...
    function getUserStatus() {
        return $http({
            ...
            if (resp.status && resp.data.success) {
                ...
                userService.setData();
                userService.setData(resp.data.account.address, resp.data.account.publicKey, resp.data.account.balance, resp.data.account.unconfirmedBalance, resp.data.account.effectiveBalance, null, resp.data.account.totalFrozeAmount, resp.data.account.username, resp.data.account.group_bonus);
